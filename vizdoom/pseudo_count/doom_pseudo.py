...
# aadditional things
parser.add_argument('--img_height', type=int, default=42)
parser.add_argument('--img_width', type=int, default=42)
parser.add_argument('--channel', type=int, default=1)
parser.add_argument('--data', type=str, default='mnist')
parser.add_argument('--conditional', action='store_true')
parser.add_argument('--filter_size', type=int, default=3)
parser.add_argument('--init_fs', type=int, default=7)
parser.add_argument('--f_map', type=int, default=16)
parser.add_argument('--f_map_fc', type=int, default=16)
...
parser.add_argument('--nr_reset', type=int, default=1)
parser.add_argument('--nr_filters', type=int, default=32)
...
args.save_dir = './simpler_pseudo/simpler_pseudo_5/'
...
#     pixel_bonus = density(FLAGS, sess, num_actions)
...
def perform_learning_step(epoch, pixel_bonus = None, steps_per_epoch = None, number_of_actions = None):
    ...
    if args.bonus:
        intrinsic_reward = pixel_bonus.bonus(s1.reshape(resolution[0] , resolution[1]) , a, epoch*learning_steps_per_epoch + steps_per_epoch, number_of_actions)
        tensorboard.log_scalar('intrinsic_reward', intrinsic_reward, epoch*learning_steps_per_epoch + steps_per_epoch)
        # print('*************************************')
...
if __name__ == '__main__':
    ...
    if args.bonus:
        ...
        tf_config.gpu_options.allow_growth=True
        sess = tf.Session(config=tf_config)
        pixel_bonus = PixelBonus(args, sess, number_of_actions)
        tf.initialize_all_variables().run(session=sess)
    ...
    if not skip_learning:
        for epoch in range(epochs):
            ...
            for learning_step in trange(learning_steps_per_epoch, leave=False):
                if args.bonus:
                    perform_learning_step(epoch, pixel_bonus, learning_step, number_of_actions)
                else:
